...
const App = memo(function App() {
  ...
  return <div className="Page-Entrance-App">
      <div className="background-image">
        <img src={snap.backgroundImage} alt="" />
      </div>
      <ConfigProvider theme={themeConfig} locale={zhCN}>
        <ContextMenu handleClick={useCallback((e, arg1) => contextMenuClick(e, (arg1 as keyof MenuMap)), [])} menuContent={menuContent} />
        <Layout>
          <Index />
        </Layout>
        <Setting drawerVisible={drawerVisible} drawerOnClose={useCallback(() => setDrawerVisible(false), [setDrawerVisible])} />
      </ConfigProvider>
    </div>;
});
export default App;