...
export default memo(function YModal(props: YModalProps) {
  ...
  return <>
      <Modal open={props.visible} centered onCancel={props.closeClick} okButtonProps={{
      disabled: true
    }} cancelButtonProps={{
      disabled: true
    }} closable={false} footer={null} width={800}
    // style={{ backgroundColor: "transparent" }}
    wrapClassName="ymodal-modal" mask={false}>
